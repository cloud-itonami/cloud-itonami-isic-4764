(ns toygameops.phase
  "Phase 0->3 staged rollout for the ISIC-4764 'Retail sale of games and
  toys in specialized stores' operations-coordination actor.
  ...
  rollout milestone still to come. This is the CHILD-PRODUCT-SAFETY op
  (choking/small-parts hazards, suspected recall-affected stock,
  age-grading-label mismatches) -- it must never be an op a human doesn't
  see before it lands. `toygameops.governor`'s own `always-escalate-ops`
  enforces the same invariant independently -- two layers, not one,
  agree on this."
  (:require [toygameops.governor :as governor]))
...
(defn verdict->disposition
  "Map a ToyGameRetailGovernor verdict to a base disposition before the
  phase gate."
  [verdict]

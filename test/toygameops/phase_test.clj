(ns toygameops.phase-test
  "Unit tests of `toygameops.phase` rollout logic."
...
(deftest safety-concern-never-in-any-phase-auto-set
  (testing ":flag-safety-concern must never be a member of any phase's :auto set -- a permanent structural fact, not a rollout milestone, given the child-product-safety stakes"
